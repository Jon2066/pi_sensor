...
class _SensorListWidget extends State<SensorListWidget> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: InkWell(
                      child: Text(sensors[index], textAlign: TextAlign.center, style:const TextStyle(fontSize: 17),),
                      onTap: () {
                        handleSelect(index);
                      },
                    ),
  ...
  void handleSelect(int index) {
    switch(index){
      case 0:
        Navigator.push(context, MaterialPageRoute(builder: (context)=>const TempSensorWidget()));
    }
  }
}
